      ...
      <main className="pt-20">
        ...
        <section className="py-24 text-center">
          <div className="container mx-auto px-4">
            ...
            <div className="inline-flex items-center gap-2 bg-whatsapp/10 text-whatsapp px-4 py-2 rounded-full text-sm font-medium mb-12">
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {plans.map((plan) => (
                <Card 
                  key={plan.name} 
                  className={`relative ${plan.color} ${plan.popular ? 'ring-2 ring-whatsapp shadow-elegant' : ''}`}
                >
                  {plan.popular && (
                    <Badge className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-whatsapp">
                      Most Popular
                    </Badge>
                  )}
                  
                  <CardHeader className="text-center pb-8">
                    <div className="w-12 h-12 mx-auto mb-4 bg-gradient-whatsapp rounded-xl flex items-center justify-center">
